...
static const GameTitle TITLES[] = {
    ...
    { 1, "841226", "A Mind Forever Voyaging (1985)", 5 },
    ...
    { 55, "850823", "Infocom Sample (1985)r", 6 },
    ...
    { 2, "840207", "Mini-Zork I (1984)", 0 },
    { 34, "871124", "Mini-Zork I (1987)", 0 },
    { 2, "871123", "Mini-Zork II (1987)", 0 },
