...
#define MUSIC_TRACK_MAX 33   /* Ceiling for the Sequential/Random mix modes and the override
                                clamp. A fixed offer, not a detected count: playing a track
                                the disc lacks is a harmless no-op. The Sound Options track
                                selector does NOT use this -- it lists the disc's real audio
                                tracks from music_cdda_audio_tracks(). */
